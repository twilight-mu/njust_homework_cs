...
<body>
	...
	<%
   		...
   		{
   			Doctor doctor=(Doctor)session.getAttribute("info");
   			session.setAttribute("writeto",doctor.getUname());
   		%>
	...
	<div class="container">
		<div class="row justify-content-md-center">
			<div class="col col-md-auto question" style="width: calc(100% - 50px);padding: 50px;">
				<div class="UserMessage">
					<img style="border-radius: 50%;height: 80px;width: 80px;" src="img/<%=doctor.getPicture()%>">
					<h2><%=doctor.getUname() %></h2>
				</div>
				<div class="Card" style="padding: 15px;">
					<div class="Card-Title">
						基本资料<button class="btn btn-primary" style="float: right;color: white;" data-toggle="modal"
