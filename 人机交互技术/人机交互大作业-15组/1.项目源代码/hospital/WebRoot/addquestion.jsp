...
<body>
  ...
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col col-md-auto question" style="width: calc(100% - 50px);padding: 50px;max-width: 670px;">
        <div>
          <h2 style="display: inline-block;">发布问题:</h2>
          <span style="float: right;margin-top: 10px;">
            请选择科室:
            <select name="major" id="major" style="width: 100px;" onchange="add1(this.value);">
        ...
        <form name="add" action="MainController" method="get">
          ...
          <div class="input-group" style="margin: 10px 0 10px 0;">
            <input class="form-control" name="title" type="text" placeholder="请输入问题的标题" style="width:300px;">
          </div>
          <div class="input-group">
            <textarea class="form-control" name="content" style="width:300px;height:100px;margin: 0 0 10px 0;"
              placeholder="描述一下你的问题吧~"></textarea>
          </div>
          <div style="float: right;">
            <a href="questionbar.jsp" class="btn" style="margin-right:10px;">返回</a>
            <input type="submit" value="发布" class="btn btn-primary" style="border-radius: 4px;" />
          </div>
