		...
		<div class="row justify-content-md-center">
			<div class="col col-md-auto question">
				<div class="question-content">
					<div class="question-title">
						<span>我们为您推荐了:</span>
						<a class="ask-btn" href="addquestion.jsp">去发表问题</a>
					</div>
					...
					<div class="card">
						...
						<p class="pusher">
							<span>
								<img src="img/<%=picture%>">
								<a
									href="<%=request.getContextPath()%>/CheckUserController?op=user&uname=<%=qt.getPublisher()%>">
									<%=qt.getPublisher() %>
								</a>
							</span>
						</p>
			...
			<div class="col col-lg-2 specialist">
				<div class="specialist-content">
					<p class="specialist-title">专家指导</p>
  			...
  			{
  			 Doctor dt=(Doctor)iter1.next();%>
					<div class="">
						<img style="margin-left:5px;border-radius: 50%;height: 40px;width:40px;"
							src="img/<%=dt.getPicture() %>">
						<a href="<%=request.getContextPath()%>/CheckUserController?op=doctor&uname=<%=dt.getUname()%>">
							<%=dt.getName() %>
						</a>
						<p class="text-center"><%=dt.getDetail() %></p>
					</div>
