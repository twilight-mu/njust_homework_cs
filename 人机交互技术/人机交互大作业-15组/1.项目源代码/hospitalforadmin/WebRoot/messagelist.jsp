...
a:active {
 ...
 <div  class="top" style="background:url(img/头.jpg);background-size:100%">
   ...
   <br><div class="main">
   <center>
   <font style="font-size:1.5vw;">留言列表</font>
   <br>
   <table border="1"width="100%" style="table-layout: fixed;" frame="void">
  		<tr style="font-size:1vw;"><th>回答内容</th><th>接收者</th><th>发布者</th><th></th></tr>
  		<%
  			ArrayList al=(ArrayList)session.getAttribute("al");
  			Iterator iter=al.iterator();
  			while(iter.hasNext())
  			{
  			Message ma=(Message)iter.next();
  		%>
  			<tr><td><%=ma.getContent()%></td>
  				<td><%=ma.getReceiver()%></td>
  				<td><%=ma.getPublisher()%></td>
  				<td><a href="<%=request.getContextPath()%>/MessageController?op=del&qt=<%=ma.getId()%>">删除</a></td>
