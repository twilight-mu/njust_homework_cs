						...
						<a href="addreply.jsp">
							<button type="button" class="Button Button--blue">
								<span style="display: inline-flex; align-items: center;">&ZeroWidthSpace;
									<svg class="Zi Zi--Edit QuestionButton-icon" fill="currentColor" viewBox="0 0 24 24"
										width="16" height="16">
										<path
	...
	<div class="Question-main">
		<div>
			<div class="Question-mainColumn">
  			...
  			User user=us.checkinfo(reply.getReplier());
  		%>
				<div class="Card AnswerCard">
					<div class="QuestionAnswer-content">
						<p><img style="border-radius: 50%;height: 40px;width:40px;" src="img/<%=user.getPicture()%>">
							<a
								href="<%=request.getContextPath()%>/CheckUserController?op=user&uname=<%=user.getUname()%>"><%=user.getName() %></a>
						</p>
